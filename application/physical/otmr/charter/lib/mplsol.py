# https://github.com/NichtJens/matplotlib-solarized-colorcycle/blob/master/mplsol.py

# changes: imported cycler directly and changed call from mpl.cycler() to cycler()
